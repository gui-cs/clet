...
Themeing is completely configurable. E.g. you'll create a `~/.tui/clet.config.json` like this:

```json
```

See [Terminal.Gui Configuration Manager](https://gui-cs.github.io/Terminal.Gui/docs/config.html) for more details.
