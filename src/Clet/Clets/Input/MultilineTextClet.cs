...
internal sealed class MultilineTextClet : IClet<string?>
{
    public string PrimaryAlias => "multiline-text";
    public IReadOnlyList<string> Aliases => ["multiline-text", "mt"];
    public string Description => "Prompts for multi-line text input and returns the entered string.";
